     ...
     public function insmydetail($userid,$user_group_id,$personal,$filepath)
    {
       ...
       try{
           ...
           else
           {
               ...
               $queryinsertml = "INSERT INTO `personal_info`(`userid`,`user_group_id`,`name`,`pan`,`legal_identifier`,`legal_identification_no`,`aadhar`,`dob`,`sex`,`address`,`education`,`institute`,`mobileno`,`filepath`,`occupation`,`company`,`date_added`,`date_modified`,`timeago`)
                VALUES ('".$userid."','".$user_group_id."','".$personal['fname']."','".$personal['pan']."','".$personal['legal_idntfr']."','".$personal['legal_idntfctn_no']."','".$personal['aadhar']."','".$newDate."','".$personal['sex']."','".$personal['address']."','".$personal['eduqulfcn']."','".$personal['institute']."','".$personal['mobno']."','".$filepath."','".$personal['occupation']."','".$personal['company']."',NOW(),NOW(),'".$time."')";
   ...
   public function relativeinfo($userid,$user_group_id,$data,$filepath)
    {
      ...
      try
      {
           ...
           // print_r($data);exit;
             ...
             (`user_id`,`user_group_id`,`name`,`pan`,`legal_identifier`,`legal_identification_no`,`aadhar`,`relationship`,`dependency_nature`,`dob`,`sex`,`address`,`education`,`filepath`,`sharehldng`,`adrshldng`,`occupation`,`company`,`date_added`,`date_modified`,`timeago`)
                VALUES 
                ('".$userid."','".$user_group_id."','".$data['fname']."','".$data['pan']."','".$data['legal_idntfr']."','".$data['legal_idntfctn_no']."','".$data['aadhar']."','".$data['relationship']."','".$depdntnature."','".$newDate."','".$data['sex']."','".$data['address']."','".$data['eduqulfcn']."','".$filepath."','".$data['shareholdng']."','".$data['adrsholdng']."','".$data['reloccupation']."','".$data['relcompany']."',NOW(),NOW(),'".$time."')";
  ...
  public function singlerelative($uid,$usergroup,$releditid)
  {
   ...
   public function updaterelative($uid,$usergroup,$data,$releditid,$filepath)
   {
       ...
       try
       {
             ...
             $qry = "UPDATE relative_info SET name ='".$data['name']."',pan ='".$data['pan']."',legal_identifier ='".$data['legal_idntfr']."',legal_identification_no ='".$data['legal_idntfctn_no']."',aadhar ='".$data['aadhar']."',dob ='".$newDate."',sex ='".$data['sex']."',address ='".$data['address']."',relationship ='".$data['relationship']."',dependency_nature ='".$depdntnature."',education ='".$data['eduqulfcn']."',filepath ='".$filepath."',sharehldng ='".$data['shareholdng']."',adrshldng ='".$data['adrsholdng']."',occupation ='".$data['occupation']."',company ='".$data['company']."',date_modified=NOW(),timeago='".$time."' WHERE id='".$releditid."' ";
             // echo $qry;exit;
             $exeget = $connection->query($qry);
    ...
    public function updatemfrindb($getuserid,$user_group_id,$mfrname,$mfrrelation,$mfreditid,$panup,$addressup,$transaction,$clientid)
    {
       $time=time();
       $connection = $this->dbtrd;
       $queryupdate="UPDATE `mfr` SET `related_party`='".$mfrname."',`relationship`='".$mfrrelation."',`pan`='".$panup."',`address`='".$addressup."',`transaction`='".$transaction."',`clientid`='".$clientid."',`date_modified`=NOW(),`timeago`='".$time."' WHERE id='".$mfreditid."'";
    ...
    public function insertmfrindb($getuserid,$user_group_id,$mfrname,$mfrrelation,$pan,$address,$transaction,$clientid)
    {
        $connection = $this->dbtrd;
        $time=time();
        $queryinsert = "INSERT INTO `mfr`
        (`user_id`,`user_group_id`,`related_party`,`relationship`,`pan`,`address`,`transaction`,`clientid`,`date_added`,`date_modified`,`timeago`)
         VALUES ('".$getuserid."','".$user_group_id."','".$mfrname."','".$mfrrelation."','".$pan."','".$address."','".$transaction."','".$clientid."',NOW(),NOW(),'".$time."')"; 
