...
$postdata = http_build_query(
    array(
        ...
        'companyID'=>urlencode('L65920MH1994PLC080618'),
        'userEnteredCaptcha'=>urlencode('witlier'),
...
$result = file_get_html('text.txt');
//echo $result;exit;
$table = $result->find('div#companyMasterData table');
