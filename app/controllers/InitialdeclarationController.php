<?php 
class InitialdeclarationController extends ControllerBase
{
    ...
    public function viewinitialformAction()
    {     
    ...
    {    
        ...
        if($this->request->isPost() == true)
        {
            ...
            {   
                $getresponse = $this->initialdeclarationcommon->getalldata($uid,$usergroup);
                $getresponse2 = $this->initialdeclarationcommon->fetchpersonlinfo($uid,$usergroup);
                $getresponse3 = $this->initialdeclarationcommon->getpastemployee($uid,$usergroup);
                $clrhouse = $this->initialdeclarationcommon->getdespdemat($uid,$usergroup);
                $getallrelative = $this->initialdeclarationcommon->getallrelative($uid,$usergroup);
                ...
                $desigtotalshares = $this->initialdeclarationcommon->desigpershareheld($uid,$usergroup);
                $getemployeecode = $this->initialdeclarationcommon->getemployeecode($uid,$usergroup);
                $desimisheldshare=$this->generatemisheldshare($uid,$usergroup);
                // print_r($desimisheldshare);exit;
    ...
    public function generateformbPDFAction()
    {
        ...
        if($this->request->isPost() == true)
        {
            if($this->request->isAjax() == true)
            {
                ...
                $pdfpath = $this->dompdfgen->getpdf($pdf_content,'check','initialdeclaration','initialdeclarationpdf');
                // print_r($pdfpath);exit;
                if(!empty($pdfpath))
                {
                    $savedata = $this->initialdeclarationcommon->saveinitialdeclare($uid,$user_group_id,$pdfpath);
    ...
    public function getfilecontentAction()
    {
        ...
        if($this->request->isPost() == true)
        {
            if($this->request->isAjax() == true)
            {
                $pdf_content = file_get_contents("declaration_form/initialdeclaration.html");
    ...
    public function getallsavedpdfAction()
    {
        ...
        if($this->request->isPost() == true)
        {
            if($this->request->isAjax() == true)
            {
                $data = $this->initialdeclarationcommon->getallsavedpdf($uid,$user_group_id);
                // print_r($data);exit;
                if(!empty($data))
                {
    ...
    public function deletepdfreqAction()
    {
        ...
        if($this->request->isPost() == true)
        {
            ...
            {   
                ...
                $result = $this->initialdeclarationcommon->delreqpdf($uid,$usergroup,$delid);
    ...
    public function sendrequestAction()
    {
        ...
        if($this->request->isPost() == true)
        {
            ...
            {   
                ...
                $getfile= $this->initialdeclarationcommon->getreqfile($reqid);
                $sendmail= $this->initialdeclarationcommon->sendmailtoapprover($reqid,$getuserapprove['approvid'],$getuserapprove['fullname'],$getfile);
    ...
    public function fetchdeclrnformdataAction()
    {
        $this->view->disable();
        $uid = $this->session->loginauthspuserfront['id'];
        $user_group_id = $this->session->loginauthspuserfront['user_group_id'];
        ...
        if($this->request->isPost() == true)
        {
            if($this->request->isAjax() == true)
            {
                ...
                $getres = $this->initialdeclarationcommon->getusrdclrnform($getmasterid['user_id'],'');
                ...
                $allusrdclrnform = $this->initialdeclarationcommon->getusrdclrnform($getmasterid['user_id'],$rslmt);
