<?php 
class ContinuousdisclosureController extends ControllerBase
{
            ...
            if($this->request->isAjax() == true)
            {
               ...
               // $uniqueid = '5e0ec764808fc';
                ...
                if(!empty($pdfpath))
                {
                      ...
                      $sendmail= $this->continuousdisclosurecommon->sendmailtoapprover($reqid,$getuserapprove['approvid'],$getuserapprove['fullname'],$pdfpath);
    ...
    public function sendrequestAction()
    {
        ...
        if($this->request->isPost() == true)
        {
            ...
            {   
                ...
                $sendmail= $this->continuousdisclosurecommon->sendmailtoapprover($reqid,$getuserapprove['approvid'],$getuserapprove['fullname'],$getfile[0]['pdfpath']);
 ...
 public function updateannualAction(){
                ...
                //print_r($company);print_r($decision);
                 ...
                 if($d2ques1 != '' || $d3ques1 != '' || $d4ques1 != '' ||  $d6ques1 != '' || $d7ques1 != '' || $d8ques1 != '' || $d9ques1 != '' || $d10ques1 != '')
                    ...
                    $getres4 = $this->continuousdisclosurecommon->upannualselfpubshare($getuserid,$d4ques1,$d4ques2,$d4ques3,$d4ques4,$uniqueid,$d4id);
                     ...
                     $getres7 = $this->continuousdisclosurecommon->upannualrelativepublicshare($getuserid,$d7ques1,$d7ques2,$d7ques3,$d7ques4,$d7ques5,$d7ques6,$uniqueid,$d7id);
                     
                     $getres8 = $this->continuousdisclosurecommon->upannualselfholdingintrst($getuserid,$user_group_id,$d8ques1,$d8ques2,$d8ques3,$uniqueid,$d8id);
                     
                     $getres9 = $this->continuousdisclosurecommon->upannualrelativepubshare($getuserid,$user_group_id,$d9ques1,$d9ques2,$d9ques3,$d9ques4,$d9ques5,$uniqueid,$d9id);
                     
                     $getres10 = $this->continuousdisclosurecommon->upannualrelativeholdingintrst($getuserid,$user_group_id,$d10ques1,$d10ques2,$d10ques3,$d10ques4,$uniqueid,$d10id);
    ...
    public function createcont_disclsrAction()
    {
        $uid = $this->session->loginauthspuserfront['id'];
        $usergroup = $this->session->loginauthspuserfront['user_group_id'];
    ...
    public function editcont_disclsrAction()
    {
        $uid = $this->session->loginauthspuserfront['id'];
        $usergroup = $this->session->loginauthspuserfront['user_group_id'];
