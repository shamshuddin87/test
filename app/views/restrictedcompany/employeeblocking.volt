    ...
    <div class="containergrid">       
        <div class="formcss">                           
            <div class="typography form_pad">
                <div class="formelementmain" style="display: none">                      
                    <form id="insertemployeerestriction" action="restrictedcompany/insertemployeerestriction" method="post" enctype="multipart/form-data" autocomplete="off" > 
                        ...
                        <section class="col col-md-4 col-xs-12">
                            ...
                            <div class="input">
                                <select id="nameofcomp" name="nameofcomp" class="form_fields form-control col-md-7 col-xs-12" required>
                                    <option value="">Select Company Name</option>
                                    <?php foreach($cmplists as $showcmp){  ?>
                                    <option value="<?php echo $showcmp['id']; ?>"><?php echo $showcmp['companyname']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </section>
                        ...
                        <section class="col col-md-4 col-xs-12">
                            ...
                            <div class="input">
                                <select id="deptaccess" name="deptaccess[]" class="form_fields form-control col-md-7 col-xs-12" required  multiple>
                                </select>
                            </div>
                        </section>
                        
                        <section class="col col-md-4 col-xs-12">
                            <label class="control-label">Employees Banned*</label>
                            <div class="input">
                                <select id="empbanned" name="empbanned[]" class="form_fields form-control col-md-7 col-xs-12" required  multiple>
                                    
                                    <?php foreach($emplists as $showemp){  ?>
                                    <option value="<?php echo $showemp['wr_id']; ?>"><?php echo $showemp['fullname']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </section>
                        ...
                        <section class="col col-md-4 col-xs-12">
                            <label class="control-label">Name Of Restricted Company*</label>
                            <div class="input">
                ...
                <table class="table datatable-responsive" class="templatetbl" id="datableabhi" dtausi = "">
                    <thead>
                        <tr>
                            ...
                            <?php if($user_group_id == 2){?><th>Employees Banned</th><?php } ?>
         ...
         <div class="table-responsive table_wraper hidetbl" >
               <h3 class="h1_heading text-center">Master Employee Restriction</h3>
                <table class="table datatable-responsive hidetbl2"  id="datableabhi2" dtausi = "">
                    <thead>
                        <tr>
                            <th>Name Of Company</th>
                            <th>Department Name</th>
                            <th>Employees Banned</th>
                            <th>Name of Listed Company</th>
                            <th>Period Of Restriction From</th>
                            <th>Period Of Restriction To</th>
                            <th>Added By</th>
                    ...
                    <tbody class="appendrow2" appendrow='1'>
                    </tbody>
                </table>
            </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
            <form action="restrictedcompany/updateemprestriction" autocomplete="off" id="updateemprestriction" class="nishana" method="post" enctype="multipart/form-data">
                ...
                <section class="col col-md-7 col-xs-12">
                          <div class="mainelem company_product">
                            <label class="control-label">Name of company in which trading is restricted*</label>
                        ...
                        <section class="col col-md-5 col-xs-12">
                            <label class="control-label">Name Of Company*</label>
                            <div class="input">
                                <input type="text" id="validators" name="validators" class="form_fields form-control col-md-7 col-xs-12" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required readonly>
                            </div>
                    ...
                    <section class="col col-md-4 col-xs-12s">
                        <label class="control-label">Period Of Restriction To </label>
                             <div class="input">
                                <input type="text" name="perdresto" id="perdresto" class="form-control bootdatepick" required readonly>
                            </div>
