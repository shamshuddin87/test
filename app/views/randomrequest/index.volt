...
<div class="row">
<div class="content">
<input type="hidden" name="rqst" id="rqst" value="<?php echo $rqst; ?>">
<input type="hidden" name="vote" id="vote" value="<?php echo $vote; ?>">
<input type="hidden" name="requserid" id="requserid" value="<?php echo $requserid; ?>">
<!-- My messages -->
...
<h1 class="cssheading">Welcome </h1>
    ...
    <form action="randomrequest/updaterqststatus" autocomplete="off" id="updaterqststatus" method="post" enctype="multipart/form-data">
