      ...
      <div class="input-group col-md-12 col-xs-12 col-sm-12">
        ...
        <div class="col-md-4 top_space">
          ...
          <select id="relationship" name="relationship" class="form_fields form-control col-md-7 col-xs-12" required="">
                  ...
                  <option value="7">Child 1</option>
                  <option value="8">Child 2</option>
...
<div id="delrelation" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <h5 style="text-align: center;">Are You Sure To Delete Relative Information?</h5> </div>
            <div class="modal-footer">
 ...
 <div id="mfrdelmodal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <h5 style="text-align: center;">Are you sure you want to delete this entry?</h5> </div>
            <div class="modal-footer">
...
<div id="mfrdelmodaledit" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Please Update Your data</h5> 
              <button type="button" class="close" data-dismiss="modal">
                    &times;</button>
