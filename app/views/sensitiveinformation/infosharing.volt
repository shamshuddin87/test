                ...
                <div class="formelementmain">                      
                    <form id="insertinfosharing" action="sensitiveinformation/insertinfosharing" method="post" enctype="multipart/form-data" autocomplete="off" > 
                       ...
                       <section class="col col-md-4 col-xs-4">
                        ...
                        <select id="selectupsi" name="selectupsi" class="form_fields form-control col-md-7 col-xs-12" >
                     <!--    <option value="" id="sectyperel" >Select Upsi Type</option> -->
						       <?php foreach($upsitypes as $rel){  ?>
						      <option value="<?php echo $rel['id']; ?>"><?php echo $rel['upsitype']; ?></option>
						      <?php } ?>
						 </select>
                        </div>
                       </section>
