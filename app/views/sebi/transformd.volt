...
<div class="mainelementfom">
    ...
    <div class="containergrid">       
        ...
        <div class="formcbtn">
        <button type="button" class="btn btn-primary" id="formdsend">Send</button>
        <button type="button" class="btn btn-primary" id="formdprevious">View Previous</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="text-align:center;">From C</h4>
      </div>
