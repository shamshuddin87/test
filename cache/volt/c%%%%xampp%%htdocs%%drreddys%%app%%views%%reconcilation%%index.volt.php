    ...
    <div class="*row">
        <div class="content">
            ...
            <div class="mainelementfom">
                <h1 class="h1_heading">Add RTA Reconcilation</h1>
                                        ...
                                        <div class="input">
                                            ...
                                            <div class="updatefile">
                                                <div class="sample_down floatleft">
                                                    <a href="samplefile\RTAReconcilation\RTAReconcilation.xlsx" download>
                                                        <p class="sample">
                ...
                <div class="table-responsive table_wraper">
                    <h2 class="h1_heading">View RTA Reconcilation</h2>
                    <div class="cssnumrws">
                        <span>Show</span>
