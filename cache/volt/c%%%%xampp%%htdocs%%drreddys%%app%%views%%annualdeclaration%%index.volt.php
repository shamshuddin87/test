         ...
         <div class="modal-body show_shadow">
            <form action="annualdeclaration/insertannual" id="inannual" method="post" autocomplete="off">
               ...
               <div class="adddiv1section1">
                  <input type="button" id = "adddiv1" class="btn btn-primary adddiv1" value="+" onclick="addhtml(this.id);">
               ...
               <div class="adddiv2section1"  style="padding-bottom: 10px;">
                  <input type="button" id = "adddiv2" class="btn btn-primary adddiv2" data-type = "addrow2" value="+" onclick="addhtml(this.id);">
               ...
               <div class="adddiv3section1"  style="padding-bottom: 10px;">
                  <input type="button" class="btn btn-primary adddiv3" value="+">
               ...
               <div class="adddiv4section1"  style="padding-bottom: 10px;">
                  <input type="button" class="btn btn-primary adddiv4" value="+">
               ...
               <div class="adddiv5section2">
                  <input type="button" class="btn btn-primary adddiv5" value="+">
               ...
               <div class="adddiv6section2"  style="padding-bottom: 10px;">
                  <input type="button" class="btn btn-primary adddiv6" value="+">
               ...
               <div class="adddiv7section2"  style="padding-bottom: 10px;">
                  <input type="button" class="btn btn-primary adddiv7" value="+">
