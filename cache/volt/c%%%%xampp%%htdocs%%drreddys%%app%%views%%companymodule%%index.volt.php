        ...
        <div class="mainelementfom content">
            ...
            <div class="">
                ...
                <div class="containergrid">
                    <div class="lstc formcss">
                        <h1 class="h1_heading">Add Company Module</h1>
                        <section class="col col-xs-12 ">
                            ...
                            <div class="input">
                                ...
                                <button type="button" id="subcmp" class="btn btn-primary">Submit</button>
                            </div>
                        </section>
                    </div>
                    <!--   <div class="boxshadow">
                    ...
                    <div class="containergrid">
                        <div class="formcss">
                            <h2 class="h1_heading">View Company Module</h2>
                            ...
                            <div class="boxshadow">
                                ...
                                <div class="updatefile">
                                    <div class="sample_down floatleft">
                                        <a href="img/cmpmodule/sample/sample.xlsx" download>
                                            <p class="sample">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h5 class="delete-title">Are You Sure To Delete Company?</h5>
            </div>
