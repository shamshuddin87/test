             ...
             <div class="coihtmldata">
                ...
                <div class="sectionbox">
                    ...
                    <div class="p-15px" style="color: ">
                        <p style="color: #000;">Do you have any actual / potential conflict of interest situations you are facing as per 'Conflict of Interest' Policy. <a href="<?php echo $baseurl ?>mainadminhtml/samplefile/Coi/agreement.pdf">Click Here</a> to download policy.</p>
