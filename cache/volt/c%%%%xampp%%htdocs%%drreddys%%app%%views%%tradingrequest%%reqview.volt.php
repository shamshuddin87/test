            ...
            <div class="mainelementfom">
                ...
                <div class="">
                    <!-- <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                        <div class="login-button-container clearfix">
                             <div class="col-xs-6 sign-in">
                                <button class="btn personal active">Personal Request</button>
                            </div>
                            
                            <div class="col-xs-6 register">
                                <button class="btn relatives">Relative Request</button>
                            </div>                               
                        </div>
                    </div> -->
                    ...
                    <div class="box_outer row col-md-12 col-xs-12 col-sm-12 row personaldetails" style="display: block;">
                        ...
                        <div class="clear"></div>
                        <div class="panel panel-white px-0">                            
                            <div class="paginationmn mx-0"></div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal">
                &times;</button>
                <h4 class="modal-title">Please Enter Your Comment</h4>
            </div>
            <div class="modal-body">
                <textarea  width="100%" id="rejectmessage"></textarea>                
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-danger mr-0" id="rejectapprov" rejectid="">Reject</button> 
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <section class="col col-md-12 col-xs-12">
                    ...
                    <h5 class="delete-title">Are You Sure To Approve All This Trades?</h5>
