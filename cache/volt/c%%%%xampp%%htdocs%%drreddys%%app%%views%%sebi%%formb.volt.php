...
<div class="mainelementfom">
    ...
    <h1 class="h1_heading text-center">Form B</h1>
           ...
           <form id="insertformb" action="sebi/insertformb" method="post" enctype="multipart/form-data" autocomplete="off" > 
                    ...
                    <section class="col col-md-6 col-xs-6">
                     ...
                     <section class="col col-md-6 col-xs-6">
                        ...
                        <section class="col col-md-6 col-xs-6" >
                            <div class="input">
                                <label class="control-label">Shares Security No.</label>
                                <input type="text" id="shrsecuno" name="shrsecuno" class="form_fields form-control col-md-7 col-xs-12"  onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 46 ' readonly>
                            </div>
                       </section>
                                
                        <section class="col col-md-6 col-xs-6" >
                            <div class="input">
                                <label class="control-label">Warrants Security No.</label>
                                <input type="text" id="wrntsecuno" name="wrntsecuno" class="form_fields form-control col-md-7 col-xs-12"  onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 46 ' readonly>
                            </div>
                       </section>
                                
                        <section class="col col-md-6 col-xs-6" >
                            <div class="input">
                                <label class="control-label">Debentures Security No.</label>
                                <input type="text" id="debntrsecuno" name="debntrsecuno" class="form_fields form-control col-md-7 col-xs-12"  onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 46 'readonly>
                            </div>
                       </section>
                         </div>
                    </section>
                     ...
                     <section class="col col-md-12 col-xs-12">
                        ...
                        <section class="col col-md-6 col-xs-6">
                            ...
                            <label class="control-label">Number of units (contracts* lot size)</label>
                             <input type="text" id="futureunitnum" name="futureunitnum" class="form_fields form-control col-md-7 col-xs-12"  onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 46 ' required>
                            </div>
                        </section>
                        ...
                        <section class="col col-md-6 col-xs-6">
                            <div class="input">
                                ...
                                <input type="text" id="futurentnlvlue" name="futurentnlvlue" class="form_fields form-control col-md-7 col-xs-12"  onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 46 ' required>
                            </div>
                       </section>
                         </div>
                    </section>
               ...
               <section class="col col-md-12 col-xs-12">
                        ...
                        <section class="col col-md-6 col-xs-6">
                            <div class="input">
                            <label class="control-label">Number of units (contracts* lot size)</label>
                             <input type="text" id="optionunitnum" name="optionunitnum" class="form_fields form-control col-md-7 col-xs-12"  onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 46 ' required>
                            </div>
                        </section>
                        ...
                        <section class="col col-md-6 col-xs-6">
                            <div class="input">
                                <label class="control-label">Notional value in Rupee terms</label>
                                <input type="text" id="optionntnlvlue" name="optionntnlvlue" class="form_fields form-control col-md-7 col-xs-12"  onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 46 ' required>
                            </div>
                       </section>
                         </div>
                    </section>
      ...
      <div class="modal-header">
        <div class="button_pdf">
            <input type="hidden" name="formbid" id="formbid">
             <div class="downloadpdf floatright pdf_button">
                <div class="pdfln floatright"></div>
                <div class="clearelement"></div>
            </div>
