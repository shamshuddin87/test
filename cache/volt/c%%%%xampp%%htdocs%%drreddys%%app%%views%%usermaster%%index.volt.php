...
-->
                ...
                <div class="typography form_pad">
                    <h2 class="text-center form_heading">Add User</h2>
                    ...
                    <form action="usermaster/insertmasterlist" id="insertmasterlist" method="post" enctype="multipart/form-data" autocomplete="off"> 
                       
                        <div class="clearelement"></div>
                        <section class="col col-md-4 ">
                            <label class="control-label">First Name *</label>
                            <div class="input">
                                <input type="text" id="firstname" name="firstname" required="required" class="form_fields form-control col-md-7 col-xs-12" onkeypress="return isAlphaNumeric_space(event,this);">
                            </div>
                        </section>
                        <section class="col col-md-4 ">
                            <label class="control-label">Last Name *</label>
                            <div class="input">
                                <input type="text" id="lastname" name="lastname" required="required" class="form_fields form-control col-md-7 col-xs-12" onkeypress="return isAlphaNumeric_space(event,this);">
                            </div>
                        </section> 
                        ...
                        <section class="col col-md-4">
                            ...
                            <div class="input">
                                <input type="email" id="email" name="email" class="form_fields form-control col-md-7 col-xs-12" required="required" >
                            </div>
                        </section>  
                      ...
                      <!--   <section class="col col-md-4 ">
                        ...
                        <section class="col col-md-4 ">
                            ...
                            <div class="input">
                                <input type="text" id="designation" name="designation" required="required" class="form_fields form-control col-md-7 col-xs-12" >
                            </div>
                        </section>
                         ...
                         <section class="col col-md-4 ">
                            ...
                            <div class="input">
                                <input type="text" id="dpdate" name="dpdate" required="required" class="form_fields form-control col-md-7 col-xs-12 bootdatepick"  readonly="readonly">
                            </div>
                        </section>
                            ...
                            <div class="input">
                                <div class="mainradiobtn">
                                    <div class="floatleft radiobtn">
                                        <input type="radio" class="flat" id="gender" name="gender" value="1" checked="" required />
                                    </div>
                                    <div class="floatleft genderlbltxt">Male</div>
                                </div>
                                <div class="mainradiobtn">
                                    <div class="floatleft radiobtn">
                                        <input type="radio" class="flat" id="gender" name="gender" value="2" />
                                    </div>
                        ...
                        <div class="control-label formgroup">
                            <button type="submit" class="btn btn-primary btnlblne floatright mstrlbtn">Submit</button> 
                        </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body show_shadow">
         <form id="updatemasterlistid" action="usermaster/updatemasterlistid" method="post" class="form-horizontal form-label-left" autocomplete="off">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="control-label form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="lastname" name="lastname" onkeypress="return isAlphaNumeric_space(event,this);" required>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                   
                   <!--  <div class="control-label form-group col-lg-6">
                       ...
                       <div class="control-label form-group col-md-6">
                        ...
                        <input type="text" class="form-control bootdatepick" id="dpdate" name="dpdate"  readonly="readonly">
                    </div>
                    ...
                    <div class="control-label form-group col-lg-6 col-xs-12">
                        ...
                        <div class="input">
                            <select id="deptaccess" name="deptaccess[]" class="form_fields form-control col-md-7 col-xs-12" multiple>
                                <!-- <option value="" >Select Department</option> -->
                                <?php foreach ($deptlist as $kc => $vc) { ?> 
                                <option value="<?php echo $vc['id'];?>" cmplink="<?php echo $vc['companyid'];?>" disabled><?php echo $vc['deptname'];?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="control-label form-group col-md-12 col-xs-12 typu">
                        ...
                        <div class="input">
                            ...
                            <input type="text" id="approvername" name="approvername" class="form_fields form-control col-md-7 col-xs-12">
                        </div>
...
<div id="myModalyesno" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body show_shadow">
          <div class="text-center form_heading">NOTE
              <div class="clearelement"></div>
...
<div id="delmod" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <h5 style="text-align: center;">Are You Sure To Delete User?</h5> </div>
            <div class="modal-footer">
