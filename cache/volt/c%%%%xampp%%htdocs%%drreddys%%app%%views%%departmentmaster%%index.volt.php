    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h5 class="delete-title">Are You Sure To Delete Department?</h5>
            </div>
            <div class="modal-footer t-center">
                <button type="button" class="btn btn-danger yesconfirm" tempid="">Yes</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Update Department Master</h4>
            </div>
                ...
                <form action="departmentmaster/updatedept" autocomplete="off" id="updatedept" class="nishana" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="control-label form-group">
                             <label class="control-label">Name of department</label>
                            <input type="text" id="deptname" name="deptname" class="form-control col-md-7 col-xs-12" onkeypress="return lettersOnly(event,this);">
                        </div>
                        <div class="control-label form-group">
                             <label class="control-label">Company Access</label>
                            <select id="cmpaccnme" name="cmpaccnme[]" class="form_fields form-control col-md-7 col-xs-12" multiple>
