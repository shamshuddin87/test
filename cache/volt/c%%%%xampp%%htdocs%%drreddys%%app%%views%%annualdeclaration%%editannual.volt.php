...
-->
      ...
      <table border="1" id="t2row<?php echo $k ?>" style="border-collapse: collapse; border: 1px solid #ccc" width="100%">
         ...
         <tr>
            ...
            <td>
               <div class="input">
                  <input type="text" class="form-control inputbox4" id="d2ques2" name="d2ques2[]" value="<?php echo $selffirm[$i]['interest']?>" maxlength= "30">
               </div>
            </td>
            <td>
               <div class="input">
      ...
      <table border="1" style="border-collapse: collapse; border: 1px solid #ccc" width="100%">
         <tr>
            <td colspan="5" style="padding-left: 22px;">
               <div class="col-md-12">
                  <label >ii. Private/Public Company (Note - please disclose even if you hold 1 share in the private company)</label>
               </div>
            </td>
         </tr>
      </table>
...
<div class="clearelement"></div>
 ...
 <div class="belowleveluserdetcss">
      ...
      <td> 
      <div class="input">
      <input type="text" class="form-control inputbox5" id="d6ques3" name="d6ques3[]" value="<?php echo $relativefirm[$i]['interest']?>"  maxlength= "30">
      </div>
      </td>
      <td>
      <div class="input">
      ...
      <table border="1"  style="border-collapse: collapse; border: 1px solid #ccc" width="100%">
          <tr> 
              ...
              <div class="">
              <label  style="padding-left: 19px;" class="">ii. Private/Public Company. <span>(Note - please disclose even if the relatives hold 1 share in the private company)</span></label>
              </div>
              </td>
          </tr>
      </table>
      ...
      <table border="1"   id="t7row<?php echo $k ?>"  style="border-collapse: collapse; border: 1px solid #ccc" width="100%">
          <tr>
              <td style="border-right: 1px solid #f7f7f7;width:2.5%"></td>   
              <td style="width: 17%">  <label class="control-label">Relative Name</label></td>
              <td style="width: 17%"><label class="control-label">Company Name</label></td>
              <td style="width: 15%"><label class="control-label">Nature of interest</label></td>
              <td style="width: 15%"><label class="control-label">No. of Shares held</label></td>
