    ...
    <div class="left_col scroll-view">
        ...
        <div class="profile clearfix">
            <div class="profile_pic">
                <img src="img/no-profile-picture-icon.png" onerror="this.src='img/no-profile-picture-icon.png'" alt="..." class="img-circle profile_img">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="">
                    ...
                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                        ...
                        <li>
                            <a  href="<?php print_r($gettermscond[$i]['file']);?>">
                       ...
                       <li>
                        ...
                        ?>
                                   ...
                                   <div class="dropdown-header"><span class="heading">Notifications (Today's)</span>
                                      <span class="count ng-binding" id="dd-notifications-count">0</span>
                                   </div>
                                   <?php  } ?>
                                </div>
