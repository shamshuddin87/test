...
<div class="mainelementfom">
  ...
  <h1 class="h1_heading text-center" style="text-align: center;">Continuous Disclosure</h1>
    <div class="tablitiledesc">
   <div class="note">
      <b>Note:</b>
       <span style="display: inline-block;padding: 5px 2px;">Continous disclosure is to be filed if there are any changes in your personal or relatives details previously submitted to DRL.</span>
   </div>
</div>
  <div class="create_button">
   <a href="continuousdisclosure/createcont_disclsr"> <button type="button" class="btn btn-primary getdata">Create Declaration</button></a>
   </div>
