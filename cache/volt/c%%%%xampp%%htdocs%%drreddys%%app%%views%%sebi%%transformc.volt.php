        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="button_pdf">
                    ...
                    <div class="downloadpdf btn btn-primary floatright">
        ...
        <div class="modal-content" style="width: 100%;">
            ...
            <div class="modal-body show_shadow">
                <div class="modal_heading">
                    <p>You can create Form C from here only if the value of shares/ ADRs traded by you does not exceed Rs. 25,00,000.</p>
                    <div class="openFormc btn btn-primary m-0" id="type1">Create Form C</div>
                    <br>
                ...
                <form id="insertformctype1" action="sebi/insertformctype1" method="post" enctype="multipart/form-data" autocomplete="off" >
                    ...
                    <section class="col col-md-4 col-xs-4">
                        <div class="input">
                            <label class="control-label">Address *</label>
                            <!--<input type="text" id="address" name="address" class="form_fields form-control col-md-7 col-xs-12" value="<?php echo $address;?>" readonly required>-->
                            <textarea id="address" name="address" class="form_fields form-control col-md-7 col-xs-12" value="<?php echo $address;?>" style="height: 36px;" readonly required><?php echo $address;?></textarea>
                        </div>
                    </section>
                    <section class="col col-md-4 col-xs-4">
                        <div class="input">
