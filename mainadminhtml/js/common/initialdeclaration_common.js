...
website('body').on('click','.getdata',function(){
 ...
 // website('#Mymodaldeclara').modal('show');
    ...
    website.ajax({
        type:"POST",
        url:'initialdeclaration/getfilecontent',
...
{
    website.ajax({
          url:'initialdeclaration/fetchinitialdeclaration',
          //data:formdata,
          method:'POST',
          //contentType:'json',
...
website('body').on('click','.formpdf', function(e)
{
    ...
    var formData = {htmldata:htmldata};
    website.ajax({
        type:"POST",
        url:'initialdeclaration/generateformbPDF',
        data: formData,
        //contentType: "application/json; charset=utf-8",
        dataType:"json",
        beforeSend: function()
...
{ 
   ...
   website.ajax({
        type:"POST",
        url:'initialdeclaration/getallsavedpdf',
...
website.ajax({
                  url:'initialdeclaration/sendrequest',
                  data:{reqid:reqid},
                  method:'POST',
                  contentType:'application/x-www-form-urlencoded; charset=UTF-8',
                  dataType:"json",
...
website.ajax({
                  url:'initialdeclaration/deletepdfreq',
                  data:{delid:delid},
                  method:'POST',
                  contentType:'application/x-www-form-urlencoded; charset=UTF-8',
                  dataType:"json",
