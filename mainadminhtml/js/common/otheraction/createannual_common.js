    ...
    if(id == 'adddiv1') {
       ...
       var getlastid = website('.appendd9').attr('plancntr');
        ...
        addhtmlnxt += '<option value="">Select Option </option>';  
         ...
         addhtmlnxt += '<td><div class="input">  <input type="text" class="form-control inputbox4" id="d9ques2" name="d9ques2[]" value="" readonly="readonly" placeholder="Company Name">  </div></td> ';
