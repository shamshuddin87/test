...
{   
    ...
    if(id == 'adddiv1') {
       ...
       var getlastid = website('.appendd4').attr('plancntr');
         ...
         addhtmlnxt += '<td><div class="input">  <input type="text" class="form-control inputbox4" id="d4ques1" name="d4ques1[]" value="" onkeypress="return isAlphaNumeric_space(event,this.value);" >  </div></td> ';
