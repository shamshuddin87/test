...
website('body').on('click','#formcsend', function(){
    var ids = [];
...
website('#type1').click(function(){
    website('#Mymodaltype1').modal({
        backdrop: 'static',
        keyboard: false
    });
});

website('#type2').click(function(){
    website('#Mymodaltype2').modal({
        backdrop: 'static',
        keyboard: false
    });
});

website('#type3').click(function(){
    website('#Mymodaltype3').modal({
        backdrop: 'static',
        keyboard: false
    });
});