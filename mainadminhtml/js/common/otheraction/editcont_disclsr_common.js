  ...
  website.ajax({
    ...
    success: function (response, textStatus, jqXHR) {
      ...
      if (id == "adddiv1") {
        ...
        addhtmlnxt +=
          ' <td><div class="input">  <input type="text" class="form-control inputbox4" id="d2ques2" name="d2ques2[]" value="Partner" readonly="readonly"></div></td>';
        addhtmlnxt +=
        ...
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td style="width: 20%"><label class="control-label">Firm Name</label>';
        addhtmlnxt += "</td>";
        ...
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td><label class="control-label">Can this relative significantly influence the decision making of this firm?</label>';
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td><label class="control-label">Do this firm have any commercial or financial transactions with Dr. Reddys Laboratories Limited or any of its group company/subsidiary?</label>';
        ...
        addhtmlnxt +=
          ' <td><div class="input">  <input type="text" class="form-control inputbox4" id="d6ques3" name="d6ques3[]" value="Partner" readonly="readonly"></div></td>';
        addhtmlnxt +=
        ...
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td style="width: 20%"><label class="control-label">Company Name</label>';
        addhtmlnxt += "</td>";
        ...
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td><label class="control-label">No. of shares held</label>';
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td><label class="control-label">Can this relative significantly influence the decision making of this company?</label>';
        addhtmlnxt += "</td>";
        ...
        addhtmlnxt +=
          '<div class="row' +
          getlastid +
          ' append_row3" style="padding-bottom:20px;" id="row' +
          getlastid +
          '" >';
        addhtmlnxt +=
          '<table style="border-collapse: collapse; border: 1px solid #ccc" width="100%" border="1">';
          ...
          if (response.dematdetail.length > 0) {
            for (var i = 0; i < response.dematdetail.length; i++) {
              if (response.dematdetail[i]["accountno"] != "") {
                ...
                dematacc +=
                  '<td width="25%">' +
                  response.dematdetail[i]["clearing_house"] +
                  "</td>";
                dematacc += "</tr>";
              }
            }
          ...
          if (response.relDematdetail.length > 0) {
            for (var i = 0; i < response.relDematdetail.length; i++) {
              if (response.relDematdetail[i]["accountno"] != "") {
                ...
                reldemat += "<td>" + j + "</td>";
                reldemat +=
                  "<td>" + response.reldetail[i]["accountno"] + "</td>";
                reldemat +=
                  "<td>" +
                  response.reldetail[i]["depository_participient"] +
                  "</td>";
                reldemat +=
                  "<td>" + response.reldetail[i]["clearing_house"] + "</td>";
                reldemat += "</tr>";
              }
            }
          } else {
