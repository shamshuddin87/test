    ...
    website.ajax({
      ...
      success: function(response, textStatus, jqXHR)
      {
        if(response.logged===true)
        {
           ...
           // console.log(response.getaccess[0].comp_trad_rest_edit); return false;
          var addhtmlnxt='';
        ...
        for(var i = 0; i < response.resdta.length; i++) 
        {
            ...
            if(response.getaccess[0].comp_trad_rest_edit==1)
            {
            ...
            else
            {
               website('.formelementmain').css('display','none');
                  ...
                  new PNotify({title: 'You Do Not Have Access To Add Company Restriction',
