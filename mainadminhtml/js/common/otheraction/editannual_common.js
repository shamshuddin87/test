...
function addhtml(clicked)
 {
   ...
   if(id == 'adddiv1') {
       ...
       var getlastid = website('.appendd2').attr('plancntr');
         ...
         addhtmlnxt+=' <td><div class="input">  <input type="text" class="form-control inputbox4" id="d2ques2" name="d2ques2[]"  maxlength= "30"></div></td>';
       ...
       var getlastid = website('.appendd3').attr('plancntr');
         ...
         addhtmlnxt += '<td><div class="input">  <input type="text" class="form-control inputbox4" id="d3ques1" name="d3ques1[]" onkeypress="return isAlphaNumeric_space(event,this.value);">  </div></td> ';
       ...
       var getlastid = website('.appendd4').attr('plancntr');
         ...
         addhtmlnxt += '<td><div class="input">  <input type="text" class="form-control inputbox4" id="d4ques1" name="d4ques1[]" onkeypress="return isAlphaNumeric_space(event,this.value);" >  </div></td> ';
       ...
       var getlastid = website('.appendd6').attr('plancntr');
        ...
        addhtmlnxt += '<td><div class="input"> <select id="d6ques1" name="d6ques1[]" class="form_fields form-control col-md-7 col-xs-12 selectbox4"  >';
         ...
         addhtmlnxt+=' <td><div class="input">  <input type="text" class="form-control inputbox4" id="d6ques2" name="d6ques2[]" ></div></td>';
          addhtmlnxt+=' <td><div class="input">  <input type="text" class="form-control inputbox4" id="d6ques3" name="d6ques3[]"  maxlength= "30"></div></td>';
       ...
       var getlastid = website('.appendd9').attr('plancntr');
        ...
        addhtmlnxt += '<option value="">Select Option </option>';   
         ...
         addhtmlnxt += '<td><div class="input">  <input type="text" class="form-control inputbox4" id="d9ques2" name="d9ques2[]" onkeypress="return isAlphaNumeric_space(event,this.value);" >  </div></td> ';
