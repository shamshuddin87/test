  ...
  website.ajax({
    ...
    success: function (response, textStatus, jqXHR) {
      ...
      if (id == "adddiv1") {
        ...
        addhtmlnxt +=
          '<td style="width: 22%"><label class="control-label">Company Name</label>';
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td><label class="control-label">Can you significantly influence the decision making of this company?</label>';
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td><label class="control-label">Do this company have any commercial or financial transactions with Dr. Reddys Laboratories Limited or any of its group company/subsidiary?</label>';
        ...
        addhtmlnxt +=
          '<td><div class="input" > <input type="text" class="form-control inputbox3" id="d1ques1" name="d1ques1[]" >  </div>';
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          ' <td><div class="input"><select id="d1ques2" name="d1ques2[]" class="form_fields form-control col-md-7 col-xs-12"  > <option value="">Select Option</option><option value="Yes">Yes</option> <option value="No">No</option> </select></div></section></td>';
        addhtmlnxt +=
          '<td><div class="input"><select id="d1ques3" name="d1ques3[]" class="form_fields form-control col-md-7 col-xs-12"  ><option value="">Select Option</option><option value="Yes">Yes</option> <option value="No">No</option> </select></div></section></td>';
        addhtmlnxt += "</tr>";
        addhtmlnxt += "</table>";
        ...
        addhtmlnxt +=
          '<div class="row' +
          getlastid +
          ' append_row3" style="padding-bottom:20px;" id="t2row' +
          getlastid +
          '" >';
        addhtmlnxt +=
          '<table style="border-collapse: collapse; border: 1px solid #ccc" width="100%" border="1">';
        addhtmlnxt += "<tr>";
        addhtmlnxt +=
          ' <td style="border-right: 1px solid #fff;width:2.0%;"></td>';
        addhtmlnxt +=
          '<td style="width: 22%"><label class="control-label">Firm Name</label>';
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td style="width: 15%"><label class="control-label">Nature of Interest</label>';
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td><label class="control-label">Can you significantly influence the decision making of this firm?</label>';
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td><label class="control-label">Do this firm have any commercial or financial transactions with Dr. Reddys Laboratories Limited or any of its group company/subsidiary?</label>';
        ...
        addhtmlnxt +=
          '<td><div class="input">  <input type="text" class="form-control inputbox4" id="d2ques1" name="d2ques1[]" >  </div></td> ';
        addhtmlnxt +=
          ' <td><div class="input">  <input type="text" class="form-control inputbox4" id="d2ques2" name="d2ques2[]"  maxlength= "30"></div></td>';
        addhtmlnxt +=
          '<td> <div class="input"> <select id="d2ques3" name="d2ques3[]" class="form_fields form-control col-md-7 col-xs-12 selectbox4"  ><option value="">Select Option </option> <option value="Yes">Yes</option> <option value="No">No</option> </select></div></td>';
        addhtmlnxt +=
          ' <td><div class="input">   <select id="d2ques4" name="d2ques4[]" class="form_fields form-control col-md-7 col-xs-12" ><option value="">Select Option</option><option value="Yes">Yes</option> <option value="No">No</option> </select></div></td>';
        addhtmlnxt += "</tr>";
        addhtmlnxt += "</table>";
        addhtmlnxt += "</div>";
        ...
        addhtmlnxt +=
          '<div class="row' +
          getlastid +
          ' append_row3" style="padding-bottom:20px;" id="t3row' +
          getlastid +
          '" >';
        addhtmlnxt +=
          '<table style="border-collapse: collapse; border: 1px solid #ccc" width="100%" border="1">';
        addhtmlnxt += "<tr>";
        addhtmlnxt +=
          ' <td style="border-right: 1px solid #fff;width:2.5%"></td>';
        addhtmlnxt +=
          '<td style="width: 22%"><label class="control-label">Company Name</label>';
        addhtmlnxt += "</td>";
        addhtmlnxt +=
        ...
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td style="width: 15%"><label class="control-label">No. of shares held</label>';
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td><label class="control-label">Can you significantly influence the decision making of this company?</label>';
        addhtmlnxt += "</td>";
        ...
        addhtmlnxt +=
          '<td><div class="input">  <input type="text" class="form-control inputbox4" id="d3ques1" name="d3ques1[]" >  </div></td> ';
        addhtmlnxt +=
          ' <td><div class="input">  <select class="form-control inputbox4" id="d3ques2" rownum="t3row' +
          getlastid +
          '" name="d3ques2[]"><option value="">Select Option</option><option value="1">Member</option><option value="2">Director</option><option value="3">Member And Director</option></select></div></td>';
        addhtmlnxt +=
          '<td><input type="text" class="form-control inputbox4" id="d3ques5" name="d3ques5[]" ></td>';
        addhtmlnxt +=
          '<td> <div class="input"> <select id="d3ques3" name="d3ques3[]" class="form_fields form-control col-md-7 col-xs-12 selectbox4"  ><option value="">Select Option </option> <option value="Yes">Yes</option> <option value="No">No</option> </select></div></td>';
        addhtmlnxt +=
          ' <td><div class="input">   <select id="d3ques4" name="d3ques4[]" class="form_fields form-control col-md-7 col-xs-12" ><option value="">Select Option</option><option value="Yes">Yes</option> <option value="No">No</option> </select></div></td>';
        addhtmlnxt += "</tr>";
        addhtmlnxt += "</table>";
        ...
        addhtmlnxt +=
          '<div class="row' +
          getlastid +
          ' append_row3" style="padding-bottom:20px;" id="t4row' +
          getlastid +
          '" >';
        addhtmlnxt +=
          '<table style="border-collapse: collapse; border: 1px solid #ccc" width="100%" border="1">';
        ...
        addhtmlnxt +=
          '<td><div class="input">  <input type="text" class="form-control inputbox4" id="d4ques1" name="d4ques1[]"  >  </div></td> ';
        addhtmlnxt +=
          ' <td><div class="input">  <input type="text" class="form-control inputbox4" id="d4ques2" name="d4ques2[]" value = "holding above 2% shares" readonly="readonly"></div></td>';
        addhtmlnxt +=
          '<td> <div class="input"> <select id="d4ques3" name="d4ques3[]" class="form_fields form-control col-md-7 col-xs-12 selectbox4"  ><option value="">Select Option </option> <option value="Yes">Yes</option> <option value="No">No</option> </select></div></td>';
        addhtmlnxt +=
          ' <td><div class="input">   <select id="d4ques4" name="d4ques4[]" class="form_fields form-control col-md-7 col-xs-12" ><option value="">Select Option</option><option value="Yes">Yes</option> <option value="No">No</option> </select></div></td>';
        addhtmlnxt += "</tr>";
        addhtmlnxt += "</table>";
        ...
        addhtmlnxt +=
          '<div class="row' +
          getlastid +
          ' append_row3" style="padding-bottom:20px;" id="t5row' +
          getlastid +
          '" >';
        addhtmlnxt +=
          '<table style="border-collapse: collapse; border: 1px solid #ccc" width="100%" border="1">';
        ...
        addhtmlnxt +=
          ' <td style="border-right: 1px solid #fff;width:2.0%"></td>';
        addhtmlnxt +=
          '<td style="width: 20%"><label class="control-label">Relative Name</label>';
        addhtmlnxt += "</td >";
        addhtmlnxt +=
          '<td style="width: 22%"><label class="control-label">Company Name</label>';
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td><label class="control-label">Can this relative significantly influence the decision making of this company?</label>';
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td><label class="control-label">Do this company have any commercial or financial transactions with Dr. Reddys Laboratories Limited or any of its group company/subsidiary?</label>';
        ...
        addhtmlnxt +=
          '<td><div class="input"> <select id="d5ques1" name="d5ques1[]" class="form_fields form-control col-md-7 col-xs-12 selectbox4"  >';
        ...
        addhtmlnxt +=
          ' <td><div class="input">  <input type="text" class="form-control inputbox4" id="d5ques2" name="d5ques2[]" ></div></td>';
        addhtmlnxt +=
          '<td> <div class="input"> <select id="d5ques3" name="d5ques3[]" class="form_fields form-control col-md-7 col-xs-12 selectbox4"  ><option value="">Select Option </option> <option value="Yes">Yes</option> <option value="No">No</option> </select></div></td>';
        addhtmlnxt +=
          ' <td><div class="input">   <select id="d5ques4" name="d5ques4[]" class="form_fields form-control col-md-7 col-xs-12" ><option value="">Select Option</option><option value="Yes">Yes</option> <option value="No">No</option> </select></div></td>';
        addhtmlnxt += "</tr>";
        addhtmlnxt += "</table>";
        ...
        addhtmlnxt +=
          '<div class="row' +
          getlastid +
          ' append_row3" style="padding-bottom:20px;" id="t6row' +
          getlastid +
          '" >';
        addhtmlnxt +=
          '<table style="border-collapse: collapse; border: 1px solid #ccc" width="100%" border=1 >';
        ...
        addhtmlnxt += ' <td style="border-right: 1px solid #fff;"></td>   ';
        addhtmlnxt +=
          '<td style="width: 15%"><label class="control-label">Relative Name</label>';
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td style="width: 15%"><label class="control-label">Firm Name</label>';
        addhtmlnxt += "</td>";
        ...
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td style="position: relative;"><label class="control-label">Can this relative significantly influence the decision making of this firm?</label>';
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td><label class="control-label">Do this firm have any commercial or financial transactions with Dr. Reddys Laboratories Limited or any of its group company/subsidiary?</label>';
        ...
        addhtmlnxt +=
          '<td><div class="input"> <select id="d6ques1" name="d6ques1[]" class="form_fields form-control col-md-7 col-xs-12 selectbox4"  >';
        addhtmlnxt += '<option value="">Select Option </option>';
        website.each(response.resdta, function (index, value) {
          addhtmlnxt +=
        ...
        addhtmlnxt +=
          ' <td><div class="input">  <input type="text" class="form-control inputbox4" id="d6ques2" name="d6ques2[]" ></div></td>';
        addhtmlnxt +=
          ' <td><div class="input">  <input type="text" class="form-control inputbox4" id="d6ques3" name="d6ques3[]"  maxlength= "30"></div></td>';
        addhtmlnxt +=
          '<td> <div class="input"> <select id="d6ques4" name="d6ques4[]" class="form_fields form-control col-md-7 col-xs-12 selectbox4"  ><option value="">Select Option </option> <option value="Yes">Yes</option> <option value="No">No</option> </select></div></td>';
        addhtmlnxt +=
          ' <td><div class="input">   <select id="d6ques5" name="d6ques5[]" class="form_fields form-control col-md-7 col-xs-12" ><option value="">Select Option</option><option value="Yes">Yes</option> <option value="No">No</option> </select></div></td>';
        addhtmlnxt += "</tr>";
        addhtmlnxt += "</table>";
        ...
        addhtmlnxt +=
          '<div class="row' +
          getlastid +
          ' append_row3" style="padding-bottom:20px;" id="t7row' +
          getlastid +
          '" >';
        addhtmlnxt +=
          '<table style="border-collapse: collapse; border: 1px solid #ccc" width="100%" border="1">';
        ...
        addhtmlnxt +=
          ' <td style="border-right: 1px solid #fff;width:2.5%"></td>';
        addhtmlnxt +=
          '<td style="width: 17%"><label class="control-label">Relative Name</label>';
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td style="width: 17%"><label class="control-label">Company Name</label>';
        addhtmlnxt += "</td>";
        ...
        addhtmlnxt +=
          '<td><div class="input"> <select id="d7ques1" name="d7ques1[]" class="form_fields form-control col-md-7 col-xs-12 selectbox4"  >';
        addhtmlnxt += '<option value="">Select Option </option>';
        website.each(response.resdta, function (index, value) {
          addhtmlnxt +=
            "<option value=" + value["id"] + ">" + value["name"] + "</option>";
        ...
        addhtmlnxt +=
          ' <td><div class="input">  <input type="text" class="form-control inputbox4" id="d7ques2" name="d7ques2[]" ></div></td>';
        addhtmlnxt +=
          ' <td><div class="input">  <select class="form-control inputbox4" id="d7ques6" rownum="t7row' +
          getlastid +
          '" name="d7ques6[]"><option value="">Select Option</option><option value="1">Member</option><option value="2">Director</option><option value="3">Member And Director</option></select></div></td>';
        addhtmlnxt +=
          ' <td><input type="text" class="form-control inputbox4" id="d7ques5" name="d7ques5[]" ></td>';
        addhtmlnxt +=
          '<td> <div class="input"> <select id="d7ques3" name="d7ques3[]" class="form_fields form-control col-md-7 col-xs-12 selectbox4"  ><option value="">Select Option </option> <option value="Yes">Yes</option> <option value="No">No</option> </select></div></td>';
        addhtmlnxt +=
          ' <td><div class="input">   <select id="d7ques4" name="d7ques4[]" class="form_fields form-control col-md-7 col-xs-12" ><option value="">Select Option</option><option value="Yes">Yes</option> <option value="No">No</option> </select></div></td>';
        addhtmlnxt += "</tr>";
        addhtmlnxt += "</table>";
        ...
        addhtmlnxt +=
          '<div class="row' +
          getlastid +
          ' append_row3" style="padding-bottom:20px;" id="t8row' +
          getlastid +
          '">';
        addhtmlnxt +=
          '<table style="border-collapse: collapse; border: 1px solid #ccc" width="100%" border="1">';
        ...
        addhtmlnxt +=
          '<td style="width: 16%"><label class="control-label">Can you significantly influence the decision making of this company?</label>';
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          "<td><label class='control-label'>Do this company have any commercial or financial transactions with Dr. Reddy's Laboratories Limited or any of its group company/subsidiary?</label>";
        addhtmlnxt += "</td>";
        ...
        addhtmlnxt +=
          ' <td><div class="input">  <input type="text" class="form-control inputbox4" id="d8ques1" name="d8ques1[]" ></div></td>';
        addhtmlnxt +=
          '<td> <div class="input"> <select id="d8ques2" name="d8ques2[]" class="form_fields form-control col-md-7 col-xs-12 selectbox4"  ><option value="">Select Option </option> <option value="Yes">Yes</option> <option value="No">No</option> </select></div></td>';
        addhtmlnxt +=
          ' <td><div class="input">   <select id="d8ques3" name="d8ques3[]" class="form_fields form-control col-md-7 col-xs-12" ><option value="">Select Option</option><option value="Yes">Yes</option> <option value="No">No</option> </select></div></td>';
        addhtmlnxt += "</tr>";
        addhtmlnxt += "</table>";
        ...
        addhtmlnxt +=
          '<div class="row' +
          getlastid +
          ' append_row3" style="padding-bottom:20px;" id="t9row' +
          getlastid +
          '" >';
        addhtmlnxt +=
          '<table style="border-collapse: collapse; border: 1px solid #ccc" width="100%" border="1">';
        ...
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td style="width: 16%"><label class="control-label">Percentage of Shares alongwith relative(%)</label>';
        addhtmlnxt += "</td>";
        addhtmlnxt +=
          '<td><label class="control-label">Can you significantly influence the decision making of this company?</label>';
        addhtmlnxt += "</td>";
        ...
        addhtmlnxt +=
          '<td><div class="input"> <select id="d9ques1" name="d9ques1[]" class="form_fields form-control col-md-7 col-xs-12 selectbox4"  >';
        addhtmlnxt += '<option value="">Select Option </option>';
        website.each(response.resdta, function (index, value) {
          addhtmlnxt +=
            "<option value=" + value["id"] + ">" + value["name"] + "</option>";
        ...
        addhtmlnxt +=
          '<td><div class="input">  <input type="text" class="form-control inputbox4" id="d9ques2" name="d9ques2[]"  >  </div></td> ';
        addhtmlnxt +=
          ' <td><div class="input">  <input type="text" class="form-control inputbox4" id="d9ques3" name="d9ques3[]" value="holding above 2% shares" readonly="readonly" ></div></td>';
        addhtmlnxt +=
          '<td> <div class="input"> <select id="d9ques4" name="d9ques4[]" class="form_fields form-control col-md-7 col-xs-12 selectbox4"  ><option value="">Select Option </option> <option value="Yes">Yes</option> <option value="No">No</option> </select></div></td>';
        addhtmlnxt +=
          ' <td><div class="input">   <select id="d9ques5" name="d9ques5[]" class="form_fields form-control col-md-7 col-xs-12" ><option value="">Select Option</option><option value="Yes">Yes</option> <option value="No">No</option> </select></div></td>';
        addhtmlnxt += "</tr>";
        addhtmlnxt += "</table>";
        ...
        addhtmlnxt +=
          '<div class="row' +
          getlastid +
          ' append_row3" style="padding-bottom:20px;" id="t10row' +
          getlastid +
          '" >';
        addhtmlnxt +=
          '<table style="border-collapse: collapse; border: 1px solid #ccc" width="100%" border="1">';
        ...
        addhtmlnxt +=
          '<td style="border-right: 1px solid #f7f7f7;width:2.5%"></td>';
        addhtmlnxt +=
          '<td><div class="input"> <select id="d10ques1" name="d10ques1[]" class="form_fields form-control col-md-7 col-xs-12 selectbox4"  >';
        addhtmlnxt += '<option value="">Select Option </option>';
        website.each(response.resdta, function (index, value) {
          addhtmlnxt +=
            "<option value=" + value["id"] + ">" + value["name"] + "</option>";
        ...
        addhtmlnxt +=
          ' <td><div class="input">  <input type="text" class="form-control inputbox4" id="d10ques2" name="d10ques2[]" ></div></td>';
        addhtmlnxt +=
          '<td> <div class="input"> <select id="d10ques3" name="d10ques3[]" class="form_fields form-control col-md-7 col-xs-12 selectbox4"  ><option value="">Select Option </option> <option value="Yes">Yes</option> <option value="No">No</option> </select></div></td>';
        addhtmlnxt +=
          ' <td><div class="input">   <select id="d10ques4" name="d10ques4[]" class="form_fields form-control col-md-7 col-xs-12" ><option value="">Select Option</option><option value="Yes">Yes</option> <option value="No">No</option> </select></div></td>';
        addhtmlnxt += "</tr>";
        addhtmlnxt += "</table>";
        ...
        if (response != 0) {
          ...
          if (response.selfcompany != 0) {
            for (var i = 0; i < response.selfcompany.length; i++) {
              ...
              addhtmlnxt +=
                '<td width="25%">' +
                response.selfcompany[i]["company"] +
                "</td>";
              addhtmlnxt +=
                '<td width="25%">' +
                response.selfcompany[i]["decision"] +
                "</td>";
              addhtmlnxt +=
                '<td width="25%">' +
                response.selfcompany[i]["transaction"] +
                "</td>";
              addhtmlnxt += "</tr>";
            }
          }
          ...
          if (response.selffirm != 0) {
            for (var i = 0; i < response.selffirm.length; i++) {
              addhtmlnxt1 += '<tr class="counter">';
              addhtmlnxt1 +=
                '<td width="25%">' + response.selffirm[i]["firm"] + "</td>";
              addhtmlnxt1 +=
                '<td width="25%">' + response.selffirm[i]["interest"] + "</td>";
              addhtmlnxt1 +=
                '<td width="25%">' + response.selffirm[i]["decision"] + "</td>";
              addhtmlnxt1 +=
                '<td width="25%">' +
                response.selffirm[i]["transaction"] +
                "</td>";
              addhtmlnxt += "</tr>";
            }
          }
          ...
          if (response.selfpubpri != 0) {
            for (var i = 0; i < response.selfpubpri.length; i++) {
              ...
              addhtmlnxt2 +=
                '<td width="25%">' +
                response.selfpubpri[i]["noofshare"] +
                "</td>";
              addhtmlnxt2 +=
                '<td width="25%">' +
                response.selfpubpri[i]["decision"] +
                "</td>";
              addhtmlnxt2 +=
                '<td width="25%">' +
                response.selfpubpri[i]["transaction"] +
                "</td>";
              addhtmlnxt += "</tr>";
            }
          }
          ...
          if (response.selfpubshare != 0) {
            for (var i = 0; i < response.selfpubshare.length; i++) {
              ...
              addhtmlnxt3 +=
                '<td width="25%">' +
                response.selfpubshare[i]["company"] +
                "</td>";
              addhtmlnxt3 +=
                '<td width="25%">' +
                response.selfpubshare[i]["interest"] +
                "</td>";
              addhtmlnxt3 +=
                '<td width="25%">' +
                response.selfpubshare[i]["decision"] +
                "</td>";
              addhtmlnxt3 +=
                '<td width="25%">' +
                response.selfpubshare[i]["transaction"] +
                "</td>";
              addhtmlnxt += "</tr>";
            }
          }
          ...
          if (response.selfholdngshare != 0) {
            for (var i = 0; i < response.selfholdngshare.length; i++) {
              ...
              addhtmlnxt7 +=
                '<td width="25%">' +
                response.selfholdngshare[i]["cmpname"] +
                "</td>";
              addhtmlnxt7 +=
                '<td width="25%">' +
                response.selfholdngshare[i]["isdecisionmaking"] +
                "</td>";
              addhtmlnxt7 +=
                '<td width="25%">' +
                response.selfholdngshare[i]["isfincltrans"] +
                "</td>";
              addhtmlnxt7 += "</tr>";
            }
          }
          ...
          if (response.relative != 0) {
            for (var i = 0; i < response.relative.length; i++) {
              if (response.relative[i]["relative"] != "") {
                ...
                addhtmlnxt4 +=
                  '<td width="25%">' +
                  response.relative[i]["relative"] +
                  "</td>";
                addhtmlnxt4 +=
                  '<td width="25%">' +
                  response.relative[i]["company"] +
                  "</td>";
                addhtmlnxt4 +=
                  '<td width="25%">' +
                  response.relative[i]["decision"] +
                  "</td>";
                addhtmlnxt4 +=
                  '<td width="25%">' +
                  response.relative[i]["transaction"] +
                  "</td>";
                addhtmlnxt += "</tr>";
              }
            }
          ...
          if (response.relativefirm != 0) {
            for (var i = 0; i < response.relativefirm.length; i++) {
              if (response.relativefirm[i]["relative"] != "") {
                ...
                addhtmlnxt5 +=
                  '<td width="25%">' +
                  response.relativefirm[i]["relative"] +
                  "</td>";
                addhtmlnxt5 +=
                  '<td width="25%">' +
                  response.relativefirm[i]["firm"] +
                  "</td>";
                addhtmlnxt5 +=
                  '<td width="25%">' +
                  response.relativefirm[i]["interest"] +
                  "</td>";
                addhtmlnxt5 +=
                  '<td width="25%">' +
                  response.relativefirm[i]["decision"] +
                  "</td>";
                addhtmlnxt5 +=
                  '<td width="25%">' +
                  response.relativefirm[i]["transaction"] +
                  "</td>";
                addhtmlnxt += "</tr>";
              }
            }
          ...
          if (response.relativepubpri != 0) {
            for (var i = 0; i < response.relativepubpri.length; i++) {
              if (response.relativepubpri[i]["relative"] != "") {
                ...
                addhtmlnxt6 +=
                  '<td width="25%">' +
                  response.relativepubpri[i]["relative"] +
                  "</td>";
                addhtmlnxt6 +=
                  '<td width="25%">' +
                  response.relativepubpri[i]["company"] +
                  "</td>";
                var interst = "";
                ...
                addhtmlnxt6 +=
                  '<td width="25%">' +
                  response.relativepubpri[i]["noofshare"] +
                  "</td>";
                addhtmlnxt6 +=
                  '<td width="25%">' +
                  response.relativepubpri[i]["decision"] +
                  "</td>";
                addhtmlnxt6 +=
                  '<td width="25%">' +
                  response.relativepubpri[i]["transaction"] +
                  "</td>";
                addhtmlnxt6 += "</tr>";
              }
            }
          ...
          if (response.relativepubshare != 0) {
            for (var i = 0; i < response.relativepubshare.length; i++) {
              if (response.relativepubshare[i]["relative"] != "") {
                ...
                addhtmlnxt8 +=
                  '<td width="25%">' +
                  response.relativepubshare[i]["relative"] +
                  "</td>";
                addhtmlnxt8 +=
                  '<td width="25%">' +
                  response.relativepubshare[i]["company"] +
                  "</td>";
                addhtmlnxt8 +=
                  '<td width="25%">' +
                  response.relativepubshare[i]["interest"] +
                  "</td>";
                addhtmlnxt8 +=
                  '<td width="25%">' +
                  response.relativepubshare[i]["decision"] +
                  "</td>";
                addhtmlnxt8 +=
                  '<td width="25%">' +
                  response.relativepubshare[i]["transaction"] +
                  "</td>";
                addhtmlnxt8 += "</tr>";
              }
            }
          ...
          if (response.relativeholdngshare != 0) {
            for (var i = 0; i < response.relativeholdngshare.length; i++) {
              if (response.relativeholdngshare[i]["relative"] != "") {
                ...
                addhtmlnxt9 +=
                  '<td width="25%">' +
                  response.relativeholdngshare[i]["relative"] +
                  "</td>";
                addhtmlnxt9 +=
                  '<td width="25%">' +
                  response.relativeholdngshare[i]["cmpname"] +
                  "</td>";
                addhtmlnxt9 +=
                  '<td width="25%">' +
                  response.relativeholdngshare[i]["isdecisionmaking"] +
                  "</td>";
                addhtmlnxt9 +=
                  '<td width="25%">' +
                  response.relativeholdngshare[i]["isfincltrans"] +
                  "</td>";
                addhtmlnxt9 += "</tr>";
              }
            }
          ...
          if (response.userlevel) {
            ...
            if (response.personaldetail["nationality"] == "Indian") {
              ...
              website(".legalidentifier").html(response.personaldetail["pan"]);
          ...
          if (response.empdetail.length > 0) {
            for (var i = 0; i < response.empdetail.length; i++) {
              if (response.empdetail[i]["emp_name"] != "") {
                ...
                pastemp +=
                  '<td width="25%">' +
                  response.empdetail[i]["emp_name"] +
                  "</td>";
                pastemp +=
                  '<td width="25%">' +
                  response.empdetail[i]["emp_desigtn"] +
                  "</td>";
                pastemp +=
                  '<td width="25%">' +
                  response.empdetail[i]["startdate"] +
                  "</td>";
                pastemp +=
                  '<td width="25%">' +
                  response.empdetail[i]["enddate"] +
                  "</td>";
                pastemp += "</tr>";
              }
            }
          ...
          if (response.mfrdetail.length > 0) {
            for (var i = 0; i < response.mfrdetail.length; i++) {
              if (response.mfrdetail[i]["related_party"] != "") {
                ...
                mfr +=
                  '<td width="25%">' +
                  response.mfrdetail[i]["related_party"] +
                  "</td>";
                mfr +=
                  '<td width="25%">' + response.mfrdetail[i]["pan"] + "</td>";
                mfr +=
                  '<td width="25%">' +
                  response.mfrdetail[i]["relationship"] +
                  "</td>";
                mfr +=
                  '<td width="25%">' +
                  response.mfrdetail[i]["address"] +
                  "</td>";
                mfr += "</tr>";
              }
            }
          ...
          if (response.dematdetail.length > 0) {
            for (var i = 0; i < response.dematdetail.length; i++) {
              if (response.dematdetail[i]["accountno"] != "") {
                ...
                dematacc +=
                  '<td width="25%">' +
                  response.dematdetail[i]["accountno"] +
                  "</td>";
                dematacc +=
                  '<td width="25%">' +
                  response.dematdetail[i]["depository_participient"] +
                  "</td>";
          ...
          //console.log(response.reldetail);
          /*---- Relative detail ----*/
          if (Object.keys(response.reldetail).length) {
            ...
            for (
              var i = 0;
              i < response.reldetail.dependency_nature.length;
              i++
            ) {
              if (response.reldetail[i]["name"] != "") {
                ...
                if (response.reldetail[i]["nationality"] == "Indian") {
                  ...
                  reldetail +=
                    "<td>" +
                    response.reldetail[i]["legal_identifier"] +
                    "</td>";
                } else {
                  reldetail += "<td></td>";
                  reldetail += "<td></td>";
                ...
                reldetail +=
                  "<td>" + response.reldetail[i]["address"] + "</td>";
                reldetail +=
                  "<td>" + response.reldetail[i]["education"] + "</td>";
                reldetail +=
                  "<td>" + response.reldetail[i]["institute"] + "</td>";
                reldetail +=
                  "<td>" + response.reldetail[i]["sharehldng"] + "</td>";
                reldetail +=
                  "<td>" + response.reldetail[i]["adrshldng"] + "</td>";
                reldetail += "</tr>";
              }
            }
          } else {
          ...
          if (response.relDematdetail.length > 0) {
            ...
            for (var i = 0; i < response.relDematdetail.length; i++) {
              if (response.relDematdetail[i]["accountno"] != "") {
                ...
                reldemat += "<td>" + j + "</td>";
                reldemat +=
                  "<td>" + response.relDematdetail[i]["name"] + "</td>";
                reldemat +=
                  "<td>" + response.relDematdetail[i]["accountno"] + "</td>";
                reldemat +=
                  "<td>" +
                  response.relDematdetail[i]["depository_participient"] +
                  "</td>";
  ...
  website.ajax({
    ...
    success: function (response) {
      ...
      if (response.logged === true) {
        ...
        website("#Mymodaldeclara #downloadpdf").append(
          '<a  href="' +
            response.pdfpath +
            '" target="_blank" class="downlodthfle btn btn-primary" style="color: white;"><span class="glyphicon glyphicon-download-alt floatleft">Download</span> </a>'
        );
...
function numberOnly() {
  ...
  if ((charCode > 47 && charCode < 58) || charCode == 46) return true;
  else return false;
}
