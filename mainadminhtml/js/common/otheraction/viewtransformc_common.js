      ...
      success: function(response, textStatus, jqXHR)
      {
        if(response.logged===true)
        {
           ...
           else
           {
            ...
            if(response.data['user_group_id']==7)
            {
              // website(' option[value="7"]').attr("selected", "selected");
              website('#Mymodaledit #category option[value=6]').prop('selected', 'selected').change();
                website('#Mymodaledit #category option[value=1]').prop('disabled', 'disabled').change();
                  website('#Mymodaledit #category option[value=2]').prop('disabled', 'disabled').change();
                    website('#Mymodaledit #category option[value=3]').prop('disabled', 'disabled').change();
                      website('#Mymodaledit #category option[value=4]').prop('disabled', 'disabled').change();
                        website('#Mymodaledit #category option[value=5]').prop('disabled', 'disabled').change();
            }
