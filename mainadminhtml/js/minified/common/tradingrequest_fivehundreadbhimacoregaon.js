...
{let formtype='form1';getform(formtype,demataccount,datetrans,approxprice,broker,place,idofcmps,typeoftranss,sectypes,typeoftranss,typeofrequests,noofshares,selrelatives,transaction,sharestrans)
...
{addhtmlnxt+='<td>'+j+'</td>';}
addhtmlnxt+='<td>'+sectype+'</td>';addhtmlnxt+='<td>'+type_of_transaction+'</td>';addhtmlnxt+='<td>'+no_of_shares+'</td>';addhtmlnxt+='<td>'+typeofrequest+'</td>';addhtmlnxt+='<td>'+nameofreq+'</td>';addhtmlnxt+='<td>'+relationship+'</td>';if(approved_status==1)
...
addhtmlnxt+='<td>'+trading_date+'</td>';addhtmlnxt+='<td>'+date_added+'</td>';if((approved_status==1&&trading_status=='')&&exception_approve!=1)
