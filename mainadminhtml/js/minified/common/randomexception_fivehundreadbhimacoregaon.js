...
{var excrqst=website('#excrqst').val();var vote=website('#vote').val();var rqstid=website('#rqstid').val();if(vote==1)
{var formdata={excrqst:excrqst,vote:vote,rqstid:rqstid}
website.ajax({url:'randomexception/updateexcrequst',data:formdata,method:'POST',contentType:'application/x-www-form-urlencoded; charset=UTF-8',dataType:"json",cache:false,beforeSend:function()
...
website.ajax({url:'randomexception/mailacknwtoexcapprvr',data:formdata,method:'POST',contentType:'application/x-www-form-urlencoded; charset=UTF-8',dataType:"json",cache:false,beforeSend:function()
{},uploadProgress:function(event,position,total,percentComplete)
{},success:function(response,textStatus,jqXHR)
{if(response.logged===true)
