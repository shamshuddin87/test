...
{if(response.logged===true)
{var j=1;var myhtml='';for(var i=0;i<response.data.length;i++)
{myhtml+='<tr>';myhtml+='<td>'+j+'</td>';myhtml+='<td>'+response.data[i].related_party+'</td>';myhtml+='<td>'+response.data[i].pan+'</td>';myhtml+='<td>'+response.data[i].relationship+'</td>';myhtml+='<td>'+response.data[i].address+'</td>';myhtml+='<td><i class="fa fa-edit mymfredit"  mfredit="'+response.data[i].id+'" style="font-size:20px;"></i><i class="fa fa-trash delmfr"  mfrdel="'+response.data[i].id+'" style="font-size:20px;"></i></td>';myhtml+='</tr>';j++;}}
else
