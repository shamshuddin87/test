...
{addhtmlnxt+='<tr class="counter" aprvllistid="'+response.resdta[k].id+'" >';addhtmlnxt+='<td width="25%">'+response.resdta[k].relationshipname+'</td>';addhtmlnxt+='<td width="25%">'+response.resdta[k].equityshare+'</td>';addhtmlnxt+='<td width="25%">'+response.resdta[k].prefershare+'</td>';if(response.equity[k]!='')
