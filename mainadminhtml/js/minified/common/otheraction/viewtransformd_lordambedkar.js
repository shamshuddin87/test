...
website('.name').html(response.formdata['fullname']);website('.cmpnme').html(response.formdata['company_name']);website('.pan').html(response.formdata['pan']);website('.cin').html(response.formdata['cin']);website('.contctno').html(response.formdata['mobile']);website('.address').html(response.formdata['address']);website('.category').html(response.formdata['cmpcnct']);website('.opngblnc').html(response.formdata['opngblnc']);website('.clsngblnc').html(response.formdata['totalamnt']);website('.pretrans').html(response.formdata['pretrans']);website('.posttrans').html(response.formdata['posttrans']);website('.fromdate').html(response.formdata['fromdate']);website('.todate').html(response.formdata['todate']);website('.dateofintimtn').html(response.formdata['dateofintimtn']);website('.acquimode').html(response.formdata['acquistnmode']);website('.buyvalue').html(response.formdata['buyvalue']);website('.buynumbrunt').html(response.formdata['buynumbrunt']);website('.sellvalue').html(response.formdata['sellvalue']);website('.sellnumbrunt').html(response.formdata['sellnumbrunt']);website('.exetrd').html(response.formdata['exetrd']);website('#modaldocument #formdid').val(id);website('#modaldocument').modal('show');}
else
