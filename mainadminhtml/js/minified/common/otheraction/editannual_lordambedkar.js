...
{loadnoofsec();FetchSubsidiries();});function addhtml(clicked)
...
{var delid=website(this).attr('recordid');var uniqueid=website(this).attr('uniqueid');var tablename=website(this).attr('table');website('#myModalyesno').modal('show');website('.yesconfirm').attr('delid',delid);website('.yesconfirm').attr('tablename',tablename);website('.yesconfirm').attr('uniqueid',uniqueid);});website('body').on('click','.yesconfirm',function(e)
{var delid=website(this).attr('delid');var uniqueid=website(this).attr('uniqueid');var tablename=website(this).attr('tablename');var formdata={delid:delid,uniqueid:uniqueid,tablename:tablename};website.ajax({url:'annualdeclaration/deleteannualdeclare',data:formdata,method:'POST',contentType:'application/x-www-form-urlencoded; charset=UTF-8',dataType:"json",cache:false,beforeSend:function()
{},uploadProgress:function(event,position,total,percentComplete)
{},success:function(response,textStatus,jqXHR)
{if(response.logged===true)
