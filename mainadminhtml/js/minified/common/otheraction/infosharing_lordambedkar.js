...
addhtmlnxt+='<td width="10%">'+category+'</td>';addhtmlnxt+='<td width="10%">'+datefrom+'</td>';addhtmlnxt+='<td width="5%">'+newtime+'</td>';addhtmlnxt+='<td width="10%">'+enddate+'</td>';addhtmlnxt+='<td width="10%">'+response.resdta[i].datashared+'</td>';addhtmlnxt+='<td width="10%">'+upsiname+'</td>';if(response.resdta[i].filepath)
...
addhtmlnxt+='<td width="5%"><i class="fa fa-bar-chart viewtrail" infoshrid="'+response.resdta[i].id+'"></i></td>';addhtmlnxt+='<td width="10%">'+response.resdta[i].fullname+'</td>';addhtmlnxt+='<td width="25%">';if(response.getaccess[0].upsi_infoshare_delete&&response.getaccess[0].upsi_infoshare_delete==1)
...
{var categoryname='';var name='';var category='';var rectype='';if(response.data[i].category!=null)
...
{rectype='userlist';categoryname='Employee';name=response.data[i].fullname;category=14;id=response.data[i].wr_id;email=response.data[i].email;wr_id=response.data[i].wr_id;}
addhtml+='<li rec_id="'+id+'" rec_type="'+rectype+'" name="'+name+'" category ="'+category+'"  email ="'+email+'"  categoryname="'+categoryname+'"  wr_id = "'+wr_id+'"  class="bottomul validatorsid">'+name;addhtml+='<div class="clearelement"></div></li>';}
...
{}});}}
website('body').on('click','.validatorsid',function(e){var recid=website(this).attr('rec_id');var rectype=website(this).attr('rec_type');var name=website(this).attr('name');var cate=website(this).attr('category');var categoryname=website(this).attr('categoryname');var email=website(this).attr('email');var wr_id=website(this).attr('wr_id');website('#insertinfosharing #search-box').val(name);website('#search-box').attr('recid',recid);website('#search-box').attr('recname',name);website('#insertinfosharing #recid').val(recid);website('#insertinfosharing #rectype').val(rectype);website('#insertinfosharing #category').val(cate);website('#insertinfosharing #emailforsendmail').val(email);website('#live-search-header-wrapper').fadeOut();website('#insertinfosharing #name').val(name);website('#insertinfosharing #categoryname').val(categoryname);website('#insertinfosharing #wr_id').val(wr_id);website('#validators').attr('recid',recid);website('#validators').attr('recname',name);});website('body').on('click','#Mymodaledit .validatorsid',function(e){var recid=website(this).attr('rec_id');var name=website(this).attr('name');var cate=website(this).attr('category');var categoryname=website(this).attr('categoryname');website('#updateinfosharing #search-box').val(name);website('#Mymodaledit #search-box').attr('recid',recid);website('#Mymodaledit #search-box').attr('recname',name);website('#Mymodaledit #live-search-header-wrapper').fadeOut();website('#updateinfosharing #recid').val(recid);website('#updateinfosharing #category').val(cate);website('#updateinfosharing #name').val(name);website('#insertinfosharing #categoryname').val(categoryname);website('#Mymodaledit #validators').attr('recid',recid);website('#Mymodaledit #validators').attr('recname',name);});website(function(){});website(".time_of_data").inputmask();website('body').on("click",".viewtrail",function(e){var infoid=website(this).attr('infoshrid');var formdata={infoid:infoid}
