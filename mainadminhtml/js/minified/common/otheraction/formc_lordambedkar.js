...
website('.name').html(response.formdata['fullname']);website('.cmpnme').html(response.formdata['company_name']);website('.pan').html(response.formdata['pan']);website('.cin').html(response.formdata['cin']);website('.contctno').html(response.formdata['mobile']);website('.opngblnc').html(response.formdata['opngblnc']);website('.pershare').html(response.pershare);website('.noofshares').html(response.formdata['tdsshare']);website('.totalamt').html(response.formdata['totalamnt']);website('.address').html(response.formdata['address']);website('.category').html(response.formdata['category']);website('.pretrans').html(response.formdata['pretrans']);website('.posttrans').html(response.formdata['posttrans']);website('.fromdate').html(ddmmyyfrom);website('.todate').html(ddmmyyto);website('.dateofintimtn').html(ddmmyyinti);website('.acquimode').html(response.formdata['acquistnmode']);website('.buyvalue').html(response.formdata['buyvalue']);website('.buynumbrunt').html(response.formdata['buynumbrunt']);website('.sellvalue').html(response.formdata['sellvalue']);website('.sellnumbrunt').html(response.formdata['sellnumbrunt']);website('.place').html(response.formdata['place']);website('.dateadded').html(finaldtadd);website('.exetrd').html(response.formdata['exetrd']);website('#modaldocument #formcid').val(id);website('#modaldocument').modal('show');}
else
