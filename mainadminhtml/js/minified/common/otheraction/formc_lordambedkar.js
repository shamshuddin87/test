...
addhtmlnxt+='<td width="20%"><i class="fa fa-file-pdf-o" id="previewc" type="'+response.resdta[i].isitesop+'" doc_id=2 formcid="'+response.resdta[i].id+'" formctype="'+response.resdta[i].typeofformc+'"></i></td>';if(response.user_group_id=='7')
