...
{var j=i+1;var tradewindw=response.data[i].trading_date.split("-");var tradewindwdte=new Date(tradewindw[2],tradewindw[1],tradewindw[0]);var trade=response.data[i].date_of_transaction.split("-");var tradedte=new Date(trade[2],trade[1],trade[0]);htmlelements+='<tr>';htmlelements+='<td width="10%">'+j+'</td>';htmlelements+='<td width="10%">'+response.data[i].fullname+'</td>';htmlelements+='<td width="10%">'+response.data[i].preclrtrade+'</td>';if(response.data[i].approved_date!=null)
