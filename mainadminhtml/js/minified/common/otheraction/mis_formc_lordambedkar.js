...
{var formcsenddate=response.data[i].send_date?response.data[i].send_date:'';var date=response.data[i].date_of_transaction;var submsndate=new Date(date.split("-").reverse().join("-"));submsndate.setDate(submsndate.getDate()+2);var dd=("0"+submsndate.getDate()).slice(-2);var mm=("0"+(submsndate.getMonth()+1)).slice(-2);var y=submsndate.getFullYear();var duesubDate=dd+'-'+mm+'-'+y;var j=i+1;htmlelements+='<tr>';htmlelements+='<td width="10%">'+j+'</td>';htmlelements+='<td width="10%">'+response.data[i].fullname+'</td>';htmlelements+='<td width="10%">'+response.data[i].date_of_transaction+'</td>';htmlelements+='<td width="10%">'+response.data[i].no_of_share+'</td>';htmlelements+='<td width="10%">'+duesubDate+'</td>';htmlelements+='<td width="10%">'+formcsenddate+'</td>';if(response.data[i].send_date)
