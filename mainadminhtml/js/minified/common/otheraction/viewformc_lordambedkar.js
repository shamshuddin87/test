...
{var noofrows=website('#noofrows').val();var pagenum=website('#pagenum').val();var formdata={noofrows:noofrows,pagenum:pagenum};website.ajax({url:'sebi/fetchformcdataforaprvl',data:formdata,method:'POST',contentType:'application/x-www-form-urlencoded; charset=UTF-8',dataType:"json",cache:false,beforeSend:function()
...
{}});}
website('body').on('click','#apprvrqstformc',function(){var id=website(this).attr('formcid');var pdfurl=website(this).attr('pdfurl');var formdata={id:id,pdfurl:pdfurl};website.ajax({url:'sebi/apprvrqstformc',data:formdata,method:'POST',contentType:'application/x-www-form-urlencoded; charset=UTF-8',dataType:"json",cache:false,beforeSend:function()
