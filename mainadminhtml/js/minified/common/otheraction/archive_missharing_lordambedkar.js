...
{new PNotify({title:'Alert!!',text:'File not available',type:'university',hide:true,styling:'bootstrap3',addclass:'dark ',});}});website('.genfile').on('click',function(e){var upsitypeid=website('#upsitypeid').val();var request=website(this).attr('request');var formdata={request:request,upsitypeid:upsitypeid}
website.ajax({url:'mis/ExportArchiveSharedInfo',data:formdata,method:'POST',contentType:'application/x-www-form-urlencoded; charset=UTF-8',dataType:"json",cache:false,beforeSend:function()
