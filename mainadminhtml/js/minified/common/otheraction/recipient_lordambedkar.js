...
{website('#insertrecipient .employeecate').css('display','none');website('#insertrecipient .othercate').css('display','block');var html='<section class="col col-md-4 col-xs-12"><div class="input"><label class="control-label">Name of Other Category*</label><input type="text" id="othercategory" name="othercategory" class="form_fields form-control col-md-7 col-xs-12"  required> </div></section>';website('#insertrecipient .othercate').html(html);website('#insertrecipient #entity').val("");website('#insertrecipient .nameofemployee').css('display','none');website('#insertrecipient #entity').attr("readonly",false);website('#insertrecipient #name').attr("required",false);}
else if(id==14)
{website('#insertrecipient .othercate').css('display','none');website('#insertrecipient .employeecate').css('display','block');website('#insertrecipient .nameofemployee').css('display','block');var html='<section class="col col-md-4 col-xs-12"><div class="input"><label class="control-label">Name of Department*</label><input type="text" id="empcategory" name="empcategory" class="form_fields form-control col-md-7 col-xs-12"  required> </div></section>';website('#insertrecipient .employeecate').html(html);website('#insertrecipient #entity').val("Dr Reddy's Laboratories Ltd.");website('#insertrecipient #entity').attr("readonly",true);website('#insertrecipient #name').attr("required",true);}
else
{website('#insertrecipient .othercate').css('display','none');website('#insertrecipient .employeecate').css('display','none');website('#insertrecipient #othercategory').removeAttr('required');website('#insertrecipient #empcategory').removeAttr('required');website('#insertrecipient .nameofemployee').css('display','none');website('#insertrecipient #entity').val("");website('#insertrecipient #entity').attr("readonly",false);website('#insertrecipient #name').attr("required",false);}});function myeditmodalhtml(id)
{if(id==16)
{website('#Mymodaledit .employeecateedit').css('display','none');website('#Mymodaledit .othercateedit').css('display','block');var html='<section class="col col-md-8 col-xs-8"><div class="input"><label class="control-label">Name of Other Category*</label><input type="text" id="othercategory" name="othercategory" class="form_fields form-control col-md-7 col-xs-12"  required> </div></section>';website('#Mymodaledit .othercateedit').html(html);website('#Mymodaledit #entity').val("");website('#Mymodaledit #entity').attr("readonly",false);website('#Mymodaledit .nameofemployee').css('display','none');website('#Mymodaledit #name').attr("required",false);}
else if(id==14)
{website('#Mymodaledit .othercateedit').css('display','none');website('#Mymodaledit .employeecateedit').css('display','block');var html='<section class="col col-md-8 col-xs-8"><div class="input"><label class="control-label">Name of Department*</label><input type="text" id="empcategory" name="empcategory" class="form_fields form-control col-md-7 col-xs-12"  required> </div></section>';website('#Mymodaledit .employeecateedit').html(html);website('#Mymodaledit #entity').val("Dr Reddy's Laboratories Ltd.");website('#Mymodaledit #entity').attr("readonly",true);website('#Mymodaledit .nameofemployee').css('display','block');website('#Mymodaledit #name').attr("required",true);}
else
{website('#Mymodaledit .othercateedit').css('display','none');website('#Mymodaledit .employeecateedit').css('display','none');website('#Mymodaledit #othercategory').removeAttr('required');website('#Mymodaledit #empcategory').removeAttr('required');website('#Mymodaledit #entity').val("");website('#Mymodaledit #entity').attr("readonly",false);website('#Mymodaledit .nameofemployee').css('display','none');website('#Mymodaledit #name').attr("required",false);}}
onkeysearchuser();function onkeysearchuser(){website('#insertrecipient #searchuser').css("display","none");website("#name").keyup(function(){var search=website('#insertrecipient #name').val();var addhtml='';website('#insertrecipient #searchuser').html("");var formdata={search:search};if(search=='')
