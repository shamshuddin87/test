...
{addhtmlnxt+='<tr class="counter" aprvllistid="'+response.resdta[k].id+'" >';addhtmlnxt+='<td width="20%">'+response.resdta[k].company_name+'</td>';addhtmlnxt+='<td width="10%">'+response.resdta[k].equityshare+'</td>';addhtmlnxt+='<td width="10%">'+response.resdta[k].prefershare+'</td>';if(response.equity[k]!='')
...
{addhtmlnxt+='<td width="10%">'+totaleq+'</td>';}
if(response.prefer.length!=0)
{addhtmlnxt+='<td width="10%">'+totalpref+'</td>';}
addhtmlnxt+='<td width="10%">'+response.resdta[k].esop+'</td>';if(response.equity.length!=0)
