...
{var noofrows=website('#noofrows').val();var pagenum=website('#pagenum').val();var search=website('#srch').val();website.ajax({url:'mis/getMisAllusers',data:{noofrows:noofrows,pagenum:pagenum,search:search},method:'POST',contentType:'application/x-www-form-urlencoded; charset=UTF-8',dataType:"json",cache:false,beforeSend:function()
