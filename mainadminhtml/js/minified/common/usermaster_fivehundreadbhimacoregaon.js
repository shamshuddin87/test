...
{var firstname=response.data[i].firstname?response.data[i].firstname:'';var lastname=response.data[i].lastname?response.data[i].lastname:'';var dpdate=response.data[i].dpdate?response.data[i].dpdate:'';var email=response.data[i].dpdate?response.data[i].email:'';var designation=response.data[i].designation?response.data[i].designation:'';var approveid=response.data[i].approvid?response.data[i].approvid:'';var approver=response.data[i].approver?response.data[i].approver:'';var employeecode=response.data[i].employeecode?response.data[i].employeecode:'';website('#Mymodaledit #mlistid').val(response.data[i].id)
